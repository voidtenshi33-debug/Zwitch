...
export const users: User[] = [
  ...
  { id: 'user-2', displayName: 'Jane S.', photoURL: findImage('avatar-2').imageUrl, email: 'jane@example.com', createdAt: '2022-11-20T10:00:00Z', joinDate: 'November 2022', avgRating: 4.9, itemsRecycled: 25, lastKnownLocality: 'Viman Nagar' },
...
export const items: Item[] = [
  {
    ...
    seller: { id: users[1].id, name: users[1].displayName!, avatarUrl: users[1].photoURL!, avgRating: users[1].avgRating },
    postedAt: '2 days ago',
  ...
  },
  {
    ...
    seller: { id: users[2].id, name: users[2].displayName!, avatarUrl: users[2].photoURL!, avgRating: users[2].avgRating },
  ...
  },
  {
    ...
    seller: { id: users[0].id, name: users[0].displayName!, avatarUrl: users[0].photoURL!, avgRating: users[0].avgRating },
    postedAt: '1 week ago',
